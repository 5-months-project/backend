...
public class ScheduleController {
    ...
    public ResponseEntity<ScheduleDTO> create(@Valid @RequestBody ScheduleCreateDTO scheduleCreateDTO, @RequestParam String useremail){
    ...
    @PreAuthorize("hasAnyRole('USER', 'ADMIN')")
    public ResponseEntity<ResultDTO> read(@PathVariable Long date,@RequestParam String useremail){
    ...
    @PutMapping("/schedule")
    @PreAuthorize("hasAnyRole('USER', 'ADMIN')")
    public ResponseEntity<ScheduleDTO> update(@Valid @RequestBody ScheduleModifyDTO scheduleModifyDTO,@RequestParam String useremail){
        Optional<User> opuser =userRepository.findOneWithAuthoritiesByUsername(useremail);
        if (opuser.isEmpty()) throw new NotFoundMemberException("해당 유저를 찾을 수 없습니다.");
        User user =opuser.get();
    ...
    @PreAuthorize("hasAnyRole('USER', 'ADMIN')")
    public ResponseEntity<ScheduleDTO> delete(@PathVariable String schedulecode,@RequestParam String useremail){
        Optional<User> opuser =userRepository.findOneWithAuthoritiesByUsername(useremail);
        if (opuser.isEmpty()) throw new NotFoundMemberException("해당 유저를 찾을 수 없습니다.");
        User user =opuser.get();
    ...
    @PreAuthorize("hasAnyRole('USER', 'ADMIN')")
    public ResponseEntity<ResultDTO> readAll(@RequestParam String useremail){
        Optional<User> opuser =userRepository.findOneWithAuthoritiesByUsername(useremail);
        if (opuser.isEmpty()) throw new NotFoundMemberException("해당 유저를 찾을 수 없습니다.");
        User user =opuser.get();
    ...
    @PreAuthorize("hasAnyRole('USER', 'ADMIN')")
    public ResponseEntity<ScheduleDTO> group_create(@Valid @RequestBody ScheduleCreateDTO scheduleCreateDTO, @PathVariable String group_code,@RequestParam String useremail){
        Optional<User> opuser =userRepository.findOneWithAuthoritiesByUsername(useremail);
        if (opuser.isEmpty()) throw new NotFoundMemberException("해당 유저를 찾을 수 없습니다.");
        User user =opuser.get();
    ...
    @PreAuthorize("hasAnyRole('USER', 'ADMIN')")
    public ResponseEntity<ResultDTO> group_read(@PathVariable String group_code,@PathVariable Long date,@RequestParam String useremail){
        Optional<User> opuser =userRepository.findOneWithAuthoritiesByUsername(useremail);
        if (opuser.isEmpty()) throw new NotFoundMemberException("해당 유저를 찾을 수 없습니다.");
        User user =opuser.get();
    ...
    @PreAuthorize("hasAnyRole('USER', 'ADMIN')")
    public ResponseEntity<ScheduleDTO> group_update(@Valid @RequestBody ScheduleModifyDTO scheduleModifyDTO,@RequestParam String useremail){
        Optional<User> opuser =userRepository.findOneWithAuthoritiesByUsername(useremail);
        if (opuser.isEmpty()) throw new NotFoundMemberException("해당 유저를 찾을 수 없습니다.");
        User user =opuser.get();
    ...
    @PreAuthorize("hasAnyRole('USER', 'ADMIN')")
    public ResponseEntity<ScheduleDTO> group_delete(@PathVariable String schedule_code, @RequestParam String useremail){
        Optional<User> opuser =userRepository.findOneWithAuthoritiesByUsername(useremail);
        if (opuser.isEmpty()) throw new NotFoundMemberException("해당 유저를 찾을 수 없습니다.");
        User user =opuser.get();
    ...
    @PreAuthorize("hasAnyRole('USER', 'ADMIN')")
    public ResponseEntity<ResultDTO> group_readAll(@PathVariable String group_code,@RequestParam String useremail){
        Optional<User> opuser =userRepository.findOneWithAuthoritiesByUsername(useremail);
        if (opuser.isEmpty()) throw new NotFoundMemberException("해당 유저를 찾을 수 없습니다.");
        User user =opuser.get();
    ...
    @PreAuthorize("hasAnyRole('USER', 'ADMIN')")
    public ResponseEntity<ScheduleDTO> group_read(@PathVariable String schedule_code,@RequestParam String useremail){
        Optional<User> opuser =userRepository.findOneWithAuthoritiesByUsername(useremail);
        if (opuser.isEmpty()) throw new NotFoundMemberException("해당 유저를 찾을 수 없습니다.");
        User user =opuser.get();
    ...
    @PreAuthorize("hasAnyRole('USER', 'ADMIN')")
    public ResponseEntity<ResultDTO> readByMonth(@PathVariable Long month,@RequestParam String useremail){
        Optional<User> opuser =userRepository.findOneWithAuthoritiesByUsername(useremail);
        if (opuser.isEmpty()) throw new NotFoundMemberException("해당 유저를 찾을 수 없습니다.");
        User user =opuser.get();
    ...
    @PreAuthorize("hasAnyRole('USER', 'ADMIN')")
    public ResponseEntity<ResultDTO> readCommings(@PathVariable Long todaydate,@RequestParam String useremail){
        Optional<User> opuser =userRepository.findOneWithAuthoritiesByUsername(useremail);
        if (opuser.isEmpty()) throw new NotFoundMemberException("해당 유저를 찾을 수 없습니다.");
        User user =opuser.get();
    ...
    @PreAuthorize("hasAnyRole('USER', 'ADMIN')")
    public ResponseEntity<ResultDTO> allReadByDate(@PathVariable Long date,@RequestParam String useremail){
        Optional<User> opuser =userRepository.findOneWithAuthoritiesByUsername(useremail);
        if (opuser.isEmpty()) throw new NotFoundMemberException("해당 유저를 찾을 수 없습니다.");
        User user =opuser.get();
